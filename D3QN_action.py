...
import numpy as np
from buffer_action import ReplayBuffer

device = T.device("cuda:0" if T.cuda.is_available() else "cpu")

class DuelingDeepQNetwork(nn.Module):
    def __init__(self, alpha, state_dim, action_dim, fc1_dim, fc2_dim, fc3_dim, fc4_dim):
        ...
        self.V = nn.Linear(fc4_dim, 1)
        self.A = nn.Linear(fc4_dim, action_dim)
...
class D3QN:
    def __init__(self, alpha, state_dim, action_dim,
                 fc1_dim, fc2_dim, fc3_dim , fc4_dim ,ckpt_dir,
                 gamma=0.99, tau=0.005, epsilon=1.0, eps_end=0.05, eps_dec=5e-7,
        ...
        self.q_eval = DuelingDeepQNetwork(alpha=alpha, state_dim=state_dim,
                                          action_dim=action_dim,
                                          fc1_dim=fc1_dim, fc2_dim=fc2_dim, fc3_dim=fc3_dim, fc4_dim=fc4_dim)
        self.q_target = DuelingDeepQNetwork(alpha=alpha, state_dim=state_dim,
                                            action_dim=action_dim,
                                            fc1_dim=fc1_dim, fc2_dim=fc2_dim, fc3_dim=fc3_dim, fc4_dim=fc4_dim)
    ...
    def load_models(self, episode):#读取模型
